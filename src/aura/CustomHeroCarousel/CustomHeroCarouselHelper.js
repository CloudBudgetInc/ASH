({
  ...
  getRecords: function(component) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      contentAction.setParam("contentType", "Headlines");
        ...
        if (state === "SUCCESS") {
          ...
          if (records) {
            const mapped = records.map(function(record) {
              ...
              if (record.contentNodes && record.contentNodes.DescRTE && record.contentNodes.DescRTE.value) {
                var dom = document.createElement('div');
                dom.innerHTML = record.contentNodes.DescRTE.value;
                record.contentNodes.DescRTE.value = dom.innerText;
              }
              ...
              return {
                contentNodes: {
                  ...
                  DescRTE: record.contentNodes && record.contentNodes.DescRTE ? record.contentNodes.DescRTE : undefined,
